...
Det finns även en tillgänglig detaljerad [referens](/cli/azure/reference-index) som dokumenterar hur du ska använda varje enskilt kommando i Azure CLI 2.0.
